...
# Marcador inicial: Formulário de Caixa
start_marker = \"document.getElementById('form-caixa')?.addEventListener('submit', async (e) => {\"
# Marcador final: O que sobreviveu da tentativa anterior de gráfico
...
if start_idx != -1 and end_idx != -1:
    # Definir o novo bloco completo e CORRETO
    new_block = \"\"\"document.getElementById('form-caixa')?.addEventListener('submit', async (e) => {
        e.preventDefault();
    ...
    // ==========================================
    // (Restaurando modais que foram apagados na quebra)

document.addEventListener('DOMContentLoaded', () => {
    ...
    window.approveProposal = async function(evt, inlineId) {
        ...
        try {
            const clienteId = item ? item.cliente_id : document.getElementById('prop-cliente').value;
            ...
            const observacoes = (item ? (item.observacoes || '') : document.getElementById('prop-obs').value) + ' | Ref OS: Proposta ' + editId.split('-')[0] + ' Data: ' + dataAgendamento;
    ...
    window.generateProposalPDF = function(evt, inlineId) {
        if (evt) evt.stopPropagation();
        const form = document.getElementById('form-proposta');
        const editId = inlineId || form.dataset.editId;
        ...
        document.getElementById('print-servico').innerText = servico;
        ...
        document.getElementById('print-valor-mo-resumo').innerText = totalVal;
        document.getElementById('print-valor-mo').innerText = totalVal;
